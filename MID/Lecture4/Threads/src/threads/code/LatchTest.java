...
public class LatchTest {
	/**
	 * {@link java.util.concurrent.CountDownLatch} Java class to synchronize
	 * your threads’ activities. <br>
	 * <br>
	 * Source:
	 ...
	 * not reusable once the count reaches to zero you can not use
	 * {@link java.util.concurrent.CountDownLatch} any more. <br>
	 * <br>
	 * Use {@link java.util.concurrent.CountDownLatch} when one thread, like
	 * main thread, require to wait for one or more threads to complete, before
	 * it can start processing. <br>
	 * <br>
	 ...
	 * architecture, where multiple services are provided by multiple threads
	 * and application can not start processing until all services have started
	 * successfully. <br>
	 * <br>
	 */
